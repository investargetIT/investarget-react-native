...
import { Image, Text, View, StatusBar, ImageBackground, Platform, ScrollView } from 'react-native';
  ...
  render() {
    return (
      <ScrollView style={{ flex: 1 }}>
        ...
        <TimelineStep icon={require("../images/timeline/stepImage1.png")} color="#FF6900" title="step1，获取项目概要" investors={this.state.timelines.filter(item=>item.transactionStatusId===1)} />
